...
const isProd = (process.env.NODE_ENV || config.NODE_ENV) === 'prod';
const resolve = file => {
...
if (isProd) {
    ...
    renderer = createRenderer(
        fs.readFileSync(resolve('./dist/server-bundle.js'), 'utf-8')
    );
...
app.listen(config.SITE_PORT, () => {
    console.log(`Site starts on http://localhost:${config.SITE_PORT}`);
});